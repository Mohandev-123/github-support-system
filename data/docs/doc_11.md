...
You must authenticate your request to pass body parameters. For more information, see Authentication.
Query parameters
...
Rate limiting
The GitHub REST API limits the number of requests you can make within a given time period. For more information about rate limits and how to check your current rate limit status, see Rate limits for the REST API.
Next steps
