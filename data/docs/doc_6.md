...
Breaking changes - GitHub DocsSkip to main contentGitHub DocsVersion: Free, Pro, & TeamSearch or ask CopilotSearch or askCopilotSelect language: current language is EnglishSearch or ask CopilotSearch or askCopilotOpen menuOpen SidebarBreaking changesLearn about breaking changes that were introduced in each REST API version.Copy as MarkdownIn this articleAbout breaking changes in the REST API
...
For more information, see "Get a code scanning analysis for a repository" in the REST API documentation.
...
The OAuth Authorization API has been deprecated since 2020.
Affected endpoints
GET /
...
For more information, see "Get a code scanning default setup configuration" in the REST API documentation and the related codeql-action CHANGELOG.
Affected endpoints
