...
Working with comments - GitHub DocsSkip to main contentGitHub DocsVersion: Free, Pro, & TeamSearch or ask CopilotSearch or askCopilotSelect language: current language is EnglishSearch or ask CopilotSearch or askCopilotOpen menuOpen SidebarWorking with commentsUsing the REST API, you can access and manage comments in your pull requests, issues, or commits.Copy as MarkdownIn this articleFor any Pull Request, GitHub provides three kinds of comment views:
