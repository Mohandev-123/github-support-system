...
Rendering data as graphs - GitHub DocsSkip to main contentGitHub DocsVersion: Free, Pro, & TeamSearch or ask CopilotSearch or askCopilotSelect language: current language is EnglishSearch or ask CopilotSearch or askCopilotOpen menuOpen SidebarRendering data as graphsLearn how to visualize the programming languages from your repository using the D3.js library and Ruby Octokit.Copy as MarkdownIn this articleIn this guide, we're going to use the API to fetch information about repositories
